...
public class ShanggchuangFrmPlant extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ShanggchuangFrmPlant frame = new ShanggchuangFrmPlant();
     ...
     * Create the frame.
     */
    public ShanggchuangFrmPlant() {     //页面布局
        ...
        upButton.addMouseListener(new MouseAdapter() {          //按钮点击事件
            ...
            public void mouseClicked(MouseEvent e) {
                if (path == null){
                    ...
                    if ("非植物".equals(name)) {
                        jLabel.setText("选择的图片是非植物");
                    }
                    else {
                                            jLabel.setText("经过网络查询这个植物是："+name);
                    }
                }
            }
        });
