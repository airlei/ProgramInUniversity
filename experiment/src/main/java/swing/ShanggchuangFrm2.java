...
public class ShanggchuangFrm2 extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ShanggchuangFrm2 frame = new ShanggchuangFrm2();
...
//        btnNewButton.setBounds(355, 264, 141, 46);
    ...
    public static void addPicture(JButton button) {
        ...
        chooser.setMultiSelectionEnabled(false);//是否可以多选文件
