...
import util.AipImageClassifyUtil;
...
public class ShanggchuangFrmAnimal extends JFrame {
     ...
     * Create the frame.
     */
    public ShanggchuangFrmAnimal() {     //页面布局
...
//        contentPane.add(jLabel);
        ...
        JSONObject jsonObject = JSON.parseObject(res); //转为对象

        JSONArray result = (JSONArray) jsonObject.get("result"); //获取对象中的数组
