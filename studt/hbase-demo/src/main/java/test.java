...
//        putCell("bigdata","Student","2001","info","name","zhangsan");
        //读取数据
//            getCells("bigdata","Student","001","info","S_Name");

        //扫描数据
        scanRows("bigdata","hbase","001","002");


/*        putCell("bigdata","hbase","002","id","id","2");
        putCell("bigdata","hbase","002","info","name","2");
        putCell("bigdata","hbase","002","info","region","2");
        putCell("bigdata","hbase","002","info","request","2");
        putCell("bigdata","hbase","002","info","activity","2");
        putCell("bigdata","hbase","002","info","organization","2");*/
