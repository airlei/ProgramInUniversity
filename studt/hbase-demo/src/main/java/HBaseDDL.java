...
public class HBaseDDL {
    ...
    public static void createNamespace(String namespace) throws  IOException {
        ...
        // // 2.2 给命令空间添加需求
         builder.addConfiguration("user","xiaozhao");
...
//        createTable("bigdata","hbase","id","info");

        //表格是否存在
        boolean tableExists = isTableExists("bigdata", "hbase");
        ...
        //创建表格
//        createTable("bigdata","student","列组名字");
