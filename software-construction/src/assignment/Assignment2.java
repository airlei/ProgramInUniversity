...
public class Assignment2 {
   ...
   static class  Equation{
       ...
       public Equation(int left_operand, int right_operand, int operator, int value) {
    ...
    private static void printExercise() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            if (equation[i].operator==0){
                ...
                System.out.println("第" + (i+1) + "题："+equation[i].left_operand+"+"+equation[i].right_operand+"=");
            }else if (equation[i].operator==1){
    ...
    private static void printCalculations() {
        ...
        for (int i = 0; i < 50; i++) {
                ...
                System.out.println("第" + (i+1) + "题："+equation[i].value);
        }
    }
